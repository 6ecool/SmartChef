...
class RecipeCardCell: UICollectionViewCell {
    ...
    private let warningIcon: UIImageView = {
        let iv = UIImageView()
        iv.image = UIImage(systemName: "exclamationmark.triangle.fill") // Треугольник
        iv.tintColor = .white
    ...
    private func checkBlacklist(for recipe: Recipe) {
        ...
        // Собираем название и ингредиенты в одну строку
